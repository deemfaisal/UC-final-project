                    ...
                    Group {
                        ...
                        .foregroundColor(Color("darkblue"))
                            ...
                            VStack {
                                ...
                                Text("في اليوم الأول نقوم ببنامج ترحيبي لطلبتنا لشرح ماهو مهم لهم في البرنامج وما سيتعلمونه والأشياء المتوقعة منهم في خلال هذا الكورس و أيضاً مساعدتهم في تنزيل البرامج المستخدمة ")
                                    .frame(width: 300, height: 120)
                                    .padding()
